        ...
        success:function(res){
            if (res.code == 200){
                ...
                if (res.code == 2003){
                    ...
                    if (b){
                        window.open("https://github.com/login/oauth/authorize?client_id=979d5293cbf3c4a4c977&redirect_uri=http://localhost:80/community/callback&scope=user&state=1")
